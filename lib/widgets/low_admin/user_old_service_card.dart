...
class UserOldServiceCard extends StatelessWidget {
  final AdminOldService? serviceData;

  const UserOldServiceCard({super.key, required this.serviceData});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow('在线设备数', service.nodeConnector.toString()),
            _buildInfoRow(
              '节点速率限制',
