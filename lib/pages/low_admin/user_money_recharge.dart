...
class UserMoneyRechargePage extends StatefulWidget {
  final int userId;

  const UserMoneyRechargePage({super.key, required this.userId});

  @override
  State<UserMoneyRechargePage> createState() => _UserMoneyRechargePageState();
}

class _UserMoneyRechargePageState extends State<UserMoneyRechargePage> {
