...
part 'admin_old_service_input.g.dart';

@JsonSerializable()
class AdminOldServiceInput {
  const AdminOldServiceInput({
  ...
  factory AdminOldServiceInput.fromJson(Map<String, Object?> json) =>
      _$AdminOldServiceInputFromJson(json);
  ...
  Map<String, Object?> toJson() => _$AdminOldServiceInputToJson(this);
}
