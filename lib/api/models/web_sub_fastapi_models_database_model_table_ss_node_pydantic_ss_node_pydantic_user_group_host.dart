...
part 'web_sub_fastapi_models_database_model_table_ss_node_pydantic_ss_node_pydantic_user_group_host.g.dart';

@JsonSerializable()
class WebSubFastapiModelsDatabaseModelTableSsNodePydanticSsNodePydanticUserGroupHost {
  const WebSubFastapiModelsDatabaseModelTableSsNodePydanticSsNodePydanticUserGroupHost({
    required this.userGroupHost,
  });

  factory WebSubFastapiModelsDatabaseModelTableSsNodePydanticSsNodePydanticUserGroupHost.fromJson(
