...
part 'admin_old_service_output.g.dart';

@JsonSerializable()
class AdminOldServiceOutput {
  const AdminOldServiceOutput({
  ...
  factory AdminOldServiceOutput.fromJson(Map<String, Object?> json) =>
      _$AdminOldServiceOutputFromJson(json);
  ...
  Map<String, Object?> toJson() => _$AdminOldServiceOutputToJson(this);
}
